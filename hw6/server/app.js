...
app.get('/videos', (req, res) => {
    res.send(JSON.stringify(videosMetadata));
});
...
app.get('/video/:id/data', (req, res) => {
    ...
    videosMetadata.forEach( (arrayItem) => {
        if (arrayItem["id"] == vid_id) {
            const return_data = arrayItem;
        }
    });
    const return_id = videosMetadata.filter()
